			...
			<div class="slideshow-wrapper">	
				<div class="preloader"></div>	
					...
					<ul data-orbit="" class="orbit-slides-container">
						<li>
							<img src="application/views/hotel_vw/config/img/hotel444.jpg">
							<div class="orbit-caption">Descripcion de la imagen</div>
						</li>
						<li>
							<img src="application/views/hotel_vw/config/img/hotel555.jpg">
							<div class="orbit-caption">Descripcion de la imagen</div>
						</li>
						<li>
							<img src="application/views/hotel_vw/config/img/hotel777.jpg">
							<div class="orbit-caption">Descripcion de la imagen</div>
						</li>
					</ul>
					</div>
...
<!-- Three-up Content Blocks -->
	...
	<div class="row">
		<div class="large-4 columns">
			<img src="application/views/hotel_vw/config/img/hotel88.jpg" />
		...
		<div class="large-4 columns">
			<img src="application/views/hotel_vw/config/img/hotel99.jpg" />
		...
		<div class="large-4 columns">
			<img src="application/views/hotel_vw/config/img/hotel1010.jpg" />
