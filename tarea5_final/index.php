<?php
	...
	//Selecionar Cod, Nombre,direccion y teléfono del contacto
	$st = 
	'SELECT cod_contacto,nombre,apellido,telefono,direccion 
	...
	while($fila = mysql_fetch_array($rs) ){
		...
		$c .= '<li><input type = "checkbox" name = "' .  $fila['cod_contacto'] .
		 '" class = "new"> &nbsp;&nbsp;&nbsp; <a class = "info_c" href = "info.php?id=' . 
		 $fila['cod_contacto'] .'" >' .
